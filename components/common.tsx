...
import { alertService, AlertType } from '../helpers/alertHelper'

export { Alert }

const Alert: NextComponentType = ({ id, fade }) =>  {
  ...
  useEffect(() => {
    ...
    // clean up const that runs when the component unmounts
    return () => {
  ...
  const omit = (arr, key) => arr.map(obj => {
